...
namespace Agencia.Controllers
{
    public class DestinoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeDestino,Cidade,UF,Pais")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeDestino,Cidade,UF,Pais")] Destino destino)
        {
            if (id != destino.Id)
            {
                return NotFound();
